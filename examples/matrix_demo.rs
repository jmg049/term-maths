...
fn main() {
    let examples = [
        (r"\begin{pmatrix} a & b \\ c & d \end{pmatrix}", "2x2 pmatrix"),
        (r"\begin{bmatrix} 1 & 0 \\ 0 & 1 \end{bmatrix}", "2x2 identity bmatrix"),
        (r"\begin{vmatrix} a & b \\ c & d \end{vmatrix}", "2x2 determinant"),
        (
